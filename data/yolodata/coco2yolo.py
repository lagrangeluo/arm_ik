...
parser.add_argument('--json_path',
                    default=r'/home/embodyrobotics/data/yolodata/xml/val.json', type=str,
                    help="input: coco format(json)")
# 这里设置.txt文件保存位置
parser.add_argument('--save_path', default=r'/home/embodyrobotics/data/yolodata/xml', type=str,
...
if __name__ == '__main__':
    ...
    for img in tqdm(data['images']):
        ...
        list_file.write('/home/embodyrobotics/data/yolodata/xml/%s.jpg\n' % (head))
    list_file.close()
