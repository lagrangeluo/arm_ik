...
annFile = r'/home/embodyrobotics/data/yolodata/xml/val.json'     #转换之后的json文件路径
img_prefix = r'/home/embodyrobotics/data/yolodata/cam_high'	#图片文件夹路径
...
catIds = coco.getCatIds(catNms=['yaban'])
